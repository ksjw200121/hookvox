...
const cases = [
  {
    industry: "美業 · 紋繡師",
    name: "從 200 讚到 1.2 萬觀看，我只做對一件事",
    beforeNum: "200",
    beforeLabel: "按讚卡關",
    afterNum: "12,000",
    afterLabel: "單支觀看",
    growth: "60x",
    before: "發了很多技術教學，認真拍、認真剪，按讚永遠停在 200～300。不知道問題在哪。",
    after: "用 Hookvox 拆了一支同領域爆款，發現開頭 3 秒才是關鍵。照著公式改了一支「紋繡師不會告訴你的 3 件事」，第一次破萬。",
  ...
  },
  {
    ...
    after: "用「數字 + 反轉」型標題跟 AI 生成的前 3 秒 Hook，同樣內容換個開場，幾支從幾百衝到 5,000+，私訊詢問明顯變多。",
  ...
  },
  {
    ...
    after: "用 Hookvox 分析美食類爆款，發現「爭議開頭 + 結尾翻轉」超有效。同一道菜改腳本，一支衝到 1.8 萬。",
  ...
  {
    industry: "健身 · 教練",
    name: "乾講知識沒人看？用爆款結構從 500 衝到 3,000+",
    beforeNum: "500",
    beforeLabel: "觀看",
    afterNum: "3,000+",
    afterLabel: "觀看",
    ...
    after: "用 Hookvox 看平台上爆款開頭跟節奏，生成多版腳本選最順的拍，幾支從 500 成長到 3,000+。",
