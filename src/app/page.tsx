            ...
            {[
              {
                icon: "🔍",
                title: "爆款公式拆解",
                desc: "貼上 IG Reels、TikTok、YouTube Shorts 網址，AI 拆解 Hook 類型、情緒觸發點、爆紅原因",
              },
              {
                icon: "🔄",
                title: "套用到你的主角",
                desc: "原影片是雞胸肉？你可以換成牛排。保留爆款結構，換掉所有具體內容，腳本變你自己的",
              },
              {
                icon: "✍️",
                title: "3 種版本腳本",
                desc: "對話演戲型、數字衝擊型、身份認同型，三個版本一次給你，選最適合的用",
              },
              {
                icon: "📋",
                title: "分鏡表自動生成",
                desc: "食譜、美業、探店、旅遊、化妝這五個行業，腳本生成後自動附上拍攝分鏡，按順序拍就好",
              },
              {
                icon: "💥",
                title: "20 個爆款標題",
              ...
              },
              {
                icon: "📊",
                title: "爆款資料庫",
                desc: "每次分析都自動儲存，建立你自己的爆款素材庫，下次創作直接翻出來參考",
              },
            ].map((f) => (
              <div
                key={f.title}
            ...
            {[
              {
                step: "01",
                title: "貼上爆款影片",
                desc: "貼上任何你覺得很紅的 IG、TikTok、YouTube 影片網址",
              },
              {
                step: "02",
                title: "填入你的資訊",
                desc: "選行業、填主題、告訴 AI 你要把爆款套用到什麼主角上",
              },
              {
                step: "03",
                title: "拿走腳本和分鏡",
              ...
              <div key={s.step} className="glass rounded-2xl p-8">
                <div className="text-5xl font-black text-brand-500/30 mb-4">
                  {s.step}
                </div>
      ...
      <footer className="border-t border-white/5 py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-6 text-sm text-white/40">
            ...
            <a href="mailto:hookvox.support@gmail.com?subject=訂閱電子報" className="hover:text-white transition-colors">訂閱電子報</a>
